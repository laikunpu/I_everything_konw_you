...
public class CommonAction {
	...
	public Bean_Result getOnline_manhua_detail_next(String json) {
		...
		Bean_common_page_Res common_page_Res = new Bean_common_page_Res(new Bean_Heard(Msg_Type.CARTOON_CODE), null);
		List<Bean_common_page> bean_common_pages = service.getComic_Page(json);
